...
exclude_patterns = [
    ...
    # IntelliJ/Java generated files or files copied from the template and not modified.
    "extensions/IntelliJ/.github",
    "extensions/IntelliJ/.gradle",
    "extensions/IntelliJ/.idea",
    "extensions/IntelliJ/.qodana",
    "extensions/IntelliJ/.run",
    "extensions/IntelliJ/build",
    "extensions/IntelliJ/gradlew*",
    "extensions/IntelliJ/qodana.yml",
    "extensions/IntelliJ/settings.gradle.kts",
    "extensions/IntelliJ/src/test",
    # Code generated by the Thrift compiler.
    "extensions/IntelliJ/src/java",
